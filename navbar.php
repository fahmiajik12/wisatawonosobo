...
<nav class="blur-burger navbar navbar-expand-lg fixed-top py-3">
    <div class="container">
        <a class="navbar-brand py-0 rounded-end-5" href="index.php" style="border: 2px solid var(--bs-body-bg);"><span class="px-2" style="background-color: var(--bs-body-bg); color: var(--bs-light-text-emphasis); border: 3px solid var(--bs-body-bg);">WISATA</span><span class="px-2">WONOSOBO</span></a>
